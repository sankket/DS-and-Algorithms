...
def pre_order_traversal(node, dfs_list):
    dfs_list.append(node.data)
    if node.left:
        pre_order_traversal(node.left, dfs_list)
    dfs_list.append(node.data)

def post_order_traversal(node, dfs_list):
    if node.left:
        post_order_traversal(node.left, dfs_list)
    if node.right:
        post_order_traversal(node.right, dfs_list)
    dfs_list.append(node.data)
    return dfs_list
